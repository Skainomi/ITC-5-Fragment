...
class FragmentSatu : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tv_text).text = this.text
        view.findViewById<Button>(R.id.btn_dialog).setOnClickListener {
            val bundle = Bundle()
            val dialogFragment = FragmentDialog();
            bundle.putString(MainActivity.EXTRA_NAME, this.text)
            dialogFragment.arguments = bundle
            dialogFragment.show(parentFragmentManager, FragmentDialog::class.java.simpleName)
        }
    }
